...
public class MemberDao {
    ...
    public List<Member> findAll() {
        ...
        try (Connection connection = MySqlConnection.getInstance().getConnection();
             ...
             ResultSet resultSet = statement.executeQuery("select member.id, member.nama, member.jenis_member_id, jenis_member.id jenis_member_id, jenis_member.nama jenis_member_name from member join jenis_member on jenis_member.id = member.jenis_member_id")) {
            ...
            while (resultSet.next()) {
                ...
                jenisMember.setNama(resultSet.getString("jenis_member_name"));
